...
export const RegisterForm: FC = () =>{
    ...
    const [passwordsNotMatchMessage, setPasswordsNotMatchMessage] = useState<string>(null);
  ...
  return (
    ...
    <form onSubmit={e => e.preventDefault()}>
      ...
      />
      {formState.errors.repeatPassword && <p>{formState.errors.repeatPassword.message}</p>}
